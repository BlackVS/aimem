...
var taskRoutes = map[string]bool{
	"POST /v1/projects/{p}/teams/{team}/assignments":                       true,
	"GET /v1/projects/{p}/teams/{team}/assignments/{attempt}":              true,
	"POST /v1/projects/{p}/teams/{team}/assignments/{attempt}/accept":      true,
	"POST /v1/projects/{p}/teams/{team}/assignments/{attempt}/decline":     true,
	"POST /v1/projects/{p}/teams/{team}/assignments/{attempt}/withdraw":    true,
	"GET /v1/projects/{p}/teams/{team}/assignments/reserved":               true,
	"POST /v1/projects/{p}/teams/{team}/assignments/{attempt}/submit":      true,
	"POST /v1/projects/{p}/teams/{team}/assignments/{attempt}/review":      true,
	"POST /v1/projects/{p}/teams/{team}/assignments/{attempt}/block":       true,
	"POST /v1/projects/{p}/teams/{team}/assignments/{attempt}/resume-work": true,
	"POST /v1/projects/{p}/teams/{team}/assignments/{attempt}/cancel":      true,
	"POST /v1/projects/{p}/teams/{team}/assignments/{attempt}/stopped":     true,
	"POST /v1/projects/{p}/teams/{team}/assignments/{attempt}/close-stop":  true,
	"POST /v1/projects/{p}/teams/{team}/handoff":                           true,
	"POST /v1/projects/{p}/teams/{team}/tasks/{task}/edit":                 true,
	"POST /v1/projects/{p}/teams/{team}/tasks/{task}/finalize":             true,
