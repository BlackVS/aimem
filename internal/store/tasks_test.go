...
func TestMigrationV10ToV11(t *testing.T) {
	...
	for _, stmt := range []string{
		...
		`DROP TABLE team_sessions`, `DROP TABLE team_session_control`, `DROP TABLE team_events`, `DROP TABLE teams`,
	} {
...
func TestMigrateToSchema13RewritesRefsAndReceipts(t *testing.T) {
	...
	for _, stmt := range []struct {
		...
		{`DROP TABLE team_sessions`, nil}, {`DROP TABLE team_session_control`, nil}, {`DROP TABLE team_events`, nil}, {`DROP TABLE teams`, nil},
	} {
	...
	for _, q := range []string{`DROP TABLE team_sessions`, `DROP TABLE team_session_control`, `DROP TABLE team_events`, `DROP TABLE teams`} {
