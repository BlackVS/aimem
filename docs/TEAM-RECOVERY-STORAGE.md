...
operator reconciles abandoned execution. HTTP, CLI and MCP recovery commands,
token rebinding and coordinator handoff remain separate increments. The complete
